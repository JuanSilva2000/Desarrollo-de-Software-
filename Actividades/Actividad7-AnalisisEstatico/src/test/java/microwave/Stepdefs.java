...
//	}
	...
	//El given de arriba, no se usa el @Delimiter ya que es antiguo, ahora se usa:
	@Given("^([A-Za-z]+) presses the following keys: (.*)$")
	public void user_presses_keys(String user, String keys) {
		List<Integer> keyList = Arrays.stream(keys.split(" "))  // Asumiendo que el delimitador es un espacio
				.map(Integer::parseInt)
				.collect(Collectors.toList());

		// System.out.println(user + " presses the following keys: " + keyList);
